  ...
  return (
    <div className='footer footer-div' id='footer'>
      <div className='contact-info-div' data-aos="flip-left">
        <a id='profile-link' className='contact-info' href="https://github.com/jordanrath" target="_blank" rel="noreferrer"><FontAwesomeIcon icon="fa-brands fa-github-square" />GitHub</a>
