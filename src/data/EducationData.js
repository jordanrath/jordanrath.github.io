...
export const EducationData = [
      ...
      },
      {
            ...
            description: 'In depth introduction to JavaScript covering basic topics and syntaxes to advanced topics such as async/await and recursion.'
      },
      {
            ...
            title: 'JavaScript Certification',
            description: 'Covers JavaScript fundamentals with an emphasis on Object Oriented Programming and Functional Programming.'
      },
      {
            ...
            description: 'Utilized popular frameworks to build single page apps such as CSS, Bootstrap, Sass, React and Redux.'
      },
      {
            ...
            description: 'Teaches principles of responsive website design such as flexbox, grid, and media queries.'
      },
      {
            ...
            description: 'Built several backend applications utilizing libraries such as Node.js, Express, Mongoose, and MongoDB.'
      },
];
