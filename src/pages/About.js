...
const About = () => {
  return (
    <div className='about about-div section' id='about'>
      <h3 data-aos-duration="2000" data-aos="fade">Hello, I'm Jordan Rath</h3>
      <h3 data-aos-duration="2000" data-aos="fade">a developer</h3>
      <div className='about-context'>
        <img data-aos="slide-right" className='about-image' src='/images/myImage.jpg' alt='My dog Cooper and I'></img>
       <div data-aos="slide-left" className='about-text'>
